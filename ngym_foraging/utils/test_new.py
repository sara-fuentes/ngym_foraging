...
sys.path.append(home + '/ngym_foraging')
sys.path.append(home + '/gym')
import gym
from ngym_foraging.wrappers import trial_hist
from ngym_foraging.wrappers import reaction_time
from ngym_foraging.wrappers import combine
from ngym_foraging.wrappers import pass_reward
from ngym_foraging.wrappers import pass_action
from ngym_foraging.wrappers import side_bias
from ngym_foraging.wrappers import manage_data as md
display_mode = True
if display_mode:
