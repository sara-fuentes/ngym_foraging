...
def _get_envs(foldername=None, env_prefix=None, allow_list=None):
    ...
    # Root path of ngym_foraging.envs folder
    env_root = Path(__file__).resolve().parent
    lib_root = 'ngym_foraging.envs.'
    ...
    for filename in filenames:
        # lib = 'ngym_foraging.envs.collections.' + l
...
NATIVE_ALLOW_LIST = [
    ...
    # 'SpatialSuppressMotion',  # TODO: raises ModuleNotFound error since requires scipy, which is not in the requirements of ngym_foraging
...
_psychopy_prefix = 'ngym_foraging.envs.psychopy.'
ALL_PSYCHOPY_ENVS = {
...
_contrib_prefix = 'ngym_foraging.envs.contrib.'
CONTRIB_ALLOW_LIST = [
    # 'AngleReproduction',
    # 'CVLearning',
    # 'ChangingEnvironment',
...
def all_envs(tag=None, psychopy=False, contrib=False, collections=False):
    """Return a list of all envs in ngym_foraging."""
